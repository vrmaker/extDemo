    ...
    var form = Ext.create('Ext.form.Panel', {
                ...
                items: [
                    {
                        ...
                        items: [
                            ...
                            {xtype: 'textfield',    fieldLabel: 'Phone 1', name: 'phone-1', width: 55, allowBlank: false},
                            {xtype: 'displayfield', value: ')'},
                            {xtype: 'textfield',    fieldLabel: 'Phone 2', name: 'phone-2', width: 55, allowBlank: false, margins: '0 5 0 0'},
                            {xtype: 'displayfield', value: '-'},
        ...
        buttons: [
            ...
            },
            {
                ...
                handler:function(){
                    var form = this.up('form').getForm();
                    var str = form.getValues();
                    Ext.Msg.alert("qq",str.title);
                }
            }
        ]
    });
